...
func initializeRegexpPatterns() map[string]*regexp.Regexp {
	...
	re["sfuiNotice"] = regexp.MustCompile(`^L (?P<date>\d{2}/\d{2}/\d{4}) - (?P<time>\d{2}:\d{2}:\d{2}): Team "(?P<winnerTeam>CT|TERRORIST)?" triggered "SFUI_Notice_(CTs_Win|Terrorists_Win|Bomb_Defused|Target_Saved|Target_Bombed)?" \(CT "(?P<ctScore>\d+)"\) \(T "(?P<tScore>\d+)"\)$`)
	...
	re["killed"] = regexp.MustCompile(`^L (?P<date>\d{2}/\d{2}/\d{4}) - (?P<time>\d{2}:\d{2}:\d{2}): "(?P<killerName>[^<]+)<\d+><(?P<killerSteamId>BOT|STEAM[^>]+)><(?P<killerTeam>CT|TERRORIST)>" \[(?P<killerX>-?\d+) (?P<killerY>-?\d+) (?P<killerZ>-?\d+)] killed "(?P<killedName>[^<]+)<\d+><(?P<killedSteamId>BOT|STEAM[^>]+)><(?P<killedTeam>CT|TERRORIST)>" \[(?P<killedX>-?\d+) (?P<killedY>-?\d+) (?P<killedZ>-?\d+)] with "(?P<killerWeapon>\w+)"\s?\(?(?P<special>[^\)]*)\)?$`)
	re["assistedKill"] = regexp.MustCompile(`^L (?P<date>\d{2}/\d{2}/\d{4}) - (?P<time>\d{2}:\d{2}:\d{2}): "(?P<killerName>[^<]+)<\d+><(?P<killerSteamId>BOT|STEAM[^>]+)><(?P<killerTeam>CT|TERRORIST)>" (?P<flashAssisted>flash-)?assisted killing "(?P<killedName>[^<]+)<\d+><(?P<killedSteamId>BOT|STEAM[^>]+)><(?P<killedTeam>CT|TERRORIST)>"$`)
	re["killedOther"] = regexp.MustCompile(`^L (?P<date>\d{2}/\d{2}/\d{4}) - (?P<time>\d{2}:\d{2}:\d{2}): "(?P<killerName>[^<]+)<\d+><(?P<killerSteamId>BOT|STEAM[^>]+)><(?P<killerTeam>CT|TERRORIST)>" \[(?P<killerX>-?\d+) (?P<killerY>-?\d+) (?P<killerZ>-?\d+)] killed other "(?P<killedName>[^<]+)<\d+>" \[(?P<killedX>-?\d+) (?P<killedY>-?\d+) (?P<killedZ>-?\d+)] with "(?P<killerWeapon>\w+)"\s?\(?(?P<special>[^\)]*)\)?$`)
	...
	re["shopping"] = regexp.MustCompile(`^L (?P<date>\d{2}/\d{2}/\d{4}) - (?P<time>\d{2}:\d{2}:\d{2}): "(?P<playerName>[^<]+)<\d+><(?P<steamId>BOT|STEAM[^>]+)><(?P<currentTeam>CT|TERRORIST)>" (?P<type>dropped|purchased|picked up) "(?P<item>[^"]+)"\s*$`)
